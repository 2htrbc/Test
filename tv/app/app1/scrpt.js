...
function setFocus(index) {
  navigableItems[currentFocusIndex]?.classList.remove("focused");
  currentFocusIndex = Math.max(0, Math.min(index, navigableItems.length - 1));
  const el = navigableItems[currentFocusIndex];
